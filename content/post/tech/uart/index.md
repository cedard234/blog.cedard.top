---
title: "手搓UART"
description: 关于UART协议的碎碎念
slug: uart
date: 2021-08-27 16:52:12+0800
categories:
    - tech
---
...
verilog的基本实现已经完成了。我们可以例化一个顶层模块，把这三个东西都放进去，然后连接输入输出。现实中，我们将用FPGA开发板实现这一点。但是在完成这一步之前，我们可以使用vivado的仿真工具先验证一下我们的猜想和代码是否正确。这一块我会在下一个博客中写出。
